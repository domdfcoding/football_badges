...
github_url = "https://github.com/domdfcoding/football_badges"

rst_prolog = f""".. |pkgname| replace:: football_badges
.. |pkgname2| replace:: ``football_badges``
